 ...
 * @returns
 */
export const getBttvEmotes = async (channelLogin: string, options?: { globals?: boolean }): Promise<StreamEmotesProviderResponse> => {
  ...
  const normalizeData = (data: BttvEmotesResponse[]): StreamEmotesProps[] => {
